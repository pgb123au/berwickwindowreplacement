"""Bulk find/replace + page rename for Narre Warren Window Replacement & Pergolas scaffold."""
...
REPLACEMENTS = [
    ("https://geelongroofrestorations.com.au", "https://berwickwindowreplacement.com.au"),
    ("geelongroofrestorations.com.au", "berwickwindowreplacement.com.au"),
    ("geelongroofrestorations", "berwickwindowreplacement"),
    ("Geelong Roof Restorations", "Narre Warren Window Replacement &amp; Pergolas"),
    ...
    ("/services/roof-painting/", "/services/timber-windows/"),
    ("/services/tile-restoration/", "/services/sliding-doors/"),
    ...
    ("Armstrong Creek", "Emerald"),
    ("Lara", "Hampton Park"),
    ("quotes@geelongroofrestorations.com.au", "quotes@berwickwindowreplacement.com.au"),
    (">G</text>", ">P</text>"),
]
...
def main():
    ...
    for old, new in [
        ...
        ("greater-geelong.astro", "city-of-casey.astro"),
    ]:
    ...
    if pkg.exists():
        ...
        s = s.replace('"name": "geelongroofrestorations"', '"name": "berwickwindowreplacement"')
