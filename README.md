# Narre Warren Window Replacement &amp; Pergolas — rank-and-rent microsite
...
| Item | Value |
|---|---|
| Domain | `berwickwindowreplacement.com.au` (registered, GoDaddy fraud-pending) |
| Live URL (interim) | https://berwickwindowreplacement.netlify.app |
...
├── pages/
│   ├── index.astro           # home (Berwick primary)
│   ├── officer.astro         # /cockatoo/
│   ├── berwick.astro         # /narre-warren/
│   ├── beaconsfield.astro    # /emerald/
│   ├── cardinia.astro        # /city-of-casey/ (shire-wide overview)
...
├── whisper.js                # "Pete's Lead from Narre Warren Window Replacement &amp; Pergolas" played to contractor before patching caller through
...
| Telnyx TeXML app | `BerwickRetainingWalls-Voicemail` (id `2955788144311535476`) |
...
| `TENANT_BRAND` | `Narre Warren Window Replacement &amp; Pergolas` (default) | What plays after the label — full whisper is `"Pete's Lead. Pete's Lead from Narre Warren Window Replacement &amp; Pergolas."` |
...
3. Submit to Google Search Console (`sc-domain:berwickwindowreplacement.com.au`).
4. Set up Google Business Profile (needs registered business name "Narre Warren Window Replacement &amp; Pergolas" first).
5. Backlink work: hipages directory, True Local AU, Yelp AU, City of Casey community pages.
6. Shortlist 2–3 retaining wall contractors in Berwick; pitch the leads with a $1,500–$2,500/mo exclusive retainer.

## Niche-fit notes

| Factor | Why this niche |
|---|---|
| Local fit | Berwick/Cockatoo estates are sloped — demand is structural, not weather-cyclical |
